...
prompts. Use it when a student asks: "Where is this idea in the actual project?"
...
| [docs/student/](../student/README.md) | Student handouts, project cards, limits, and AI coding prompts. | Students need instructions or rescue prompts. |
| [docs/mentor/](../mentor/README.md) | Mentor guide, curriculum notes, and rubric. | Facilitators need review and assessment guidance. |
...
|---|---|---|---|
| [Session 1: Why AI Matters And What Soma Does](./sessions/01-ideation-ai-basics.md) | [Why AI Matters Now](./lessons/01-ai-history-and-future.md) | [reference/](../../reference/), [starter/](../../starter/), [docs/getting-started.md](../getting-started.md) | [Add Responsible AI Note](../student/ai-coding-prompts.md#add-responsible-ai-note) |
| [Session 2: Web App Scaffold](./sessions/02-web-app-scaffold.md) | [How Web Apps Work](./lessons/02-how-web-apps-work.md), [Soma App Architecture](./lessons/03-soma-architecture.md), [Frontend Walkthrough](./lessons/04-frontend-walkthrough.md) | [starter/index.html](../../starter/index.html), [starter/app.js](../../starter/app.js), [starter/style.css](../../starter/style.css), [scripts/mock-coach-server.js](../../scripts/mock-coach-server.js), [reference/index.html](../../reference/index.html), [reference/app.js](../../reference/app.js) | [Fix A JavaScript Error](../student/ai-coding-prompts.md#fix-a-javascript-error), [Make The UI Clearer](../student/ai-coding-prompts.md#make-the-ui-clearer) |
| [Session 3: Data And Intelligence](./sessions/03-data-intelligence.md) | [Data And Context](./lessons/05-data-and-context.md), [LLM Prompts](./lessons/06-llm-prompts.md), [Calling The LLM](./lessons/07-calling-the-llm.md) | [starter/data.js](../../starter/data.js), [starter/app.js](../../starter/app.js); compare with [reference/data.js](../../reference/data.js), [reference/app.js](../../reference/app.js), and [api/coach.js](../../api/coach.js) after the scaffold pattern is clear | [Create Dummy Data](../student/ai-coding-prompts.md#create-dummy-data), [Build The /api/coach Context](../student/ai-coding-prompts.md#build-the-apicoach-context) |
| [Session 4: Integrate Intelligence Into UX](./sessions/04-integrate-ai-ux.md) | [Parsing And Rendering](./lessons/08-parsing-and-rendering.md), [Language And Swahili](./lessons/09-language-and-swahili.md) | [reference/app.js](../../reference/app.js), [reference/index.html](../../reference/index.html), [reference/style.css](../../reference/style.css), [api/coach.js](../../api/coach.js) | [Response Not Rendering](../student/ai-coding-prompts.md#response-not-rendering), [Follow-Up Not Grounded](../student/ai-coding-prompts.md#follow-up-not-grounded) |
| [Session 5: Testing And Responsible AI](./sessions/05-testing-responsible-ai.md) | [Safety And Variability](./lessons/12-safety-and-variability.md), [Where LLMs Fit](./lessons/10-where-llms-fit.md) | [tests/soma-student.spec.js](../../tests/soma-student.spec.js), [docs/api-safety-checklist.md](../api-safety-checklist.md), [docs/testing-debugging.md](../testing-debugging.md) | [Add Test Cases](../student/ai-coding-prompts.md#add-test-cases), [Personal Data In Context](../student/ai-coding-prompts.md#personal-data-in-context) |
| [Session 6: Demo And Pitch](./sessions/06-demo-pitch.md) | [Build Your Own](./lessons/13-build-your-own.md) | [docs/mentor/rubric.md](../mentor/rubric.md), [docs/student/handout.md](../student/handout.md), [README.md](../../README.md) | [Add Responsible AI Note](../student/ai-coding-prompts.md#add-responsible-ai-note), [Generate A Project Plan](../student/ai-coding-prompts.md#generate-a-project-plan) |

## Concept To Code Map

| Concept | Read First | Find It In Code | Try This Lab |
|---|---|---|---|
| Browser app structure | [How Web Apps Work](./lessons/02-how-web-apps-work.md) | [starter/index.html](../../starter/index.html), [starter/style.css](../../starter/style.css), [starter/app.js](../../starter/app.js); compare with [reference/](../../reference/) later | [Lab A](./labs/README.md#lab-a-change-one-ui-section-safely) |
| Public app versus scaffold | [Soma App Architecture](./lessons/03-soma-architecture.md) | [starter/](../../starter/), [reference/](../../reference/), [scripts/mock-coach-server.js](../../scripts/mock-coach-server.js) | [Lab A](./labs/README.md#lab-a-change-one-ui-section-safely) |
| DOM IDs and event listeners | [Frontend Walkthrough](./lessons/04-frontend-walkthrough.md) | [starter/index.html](../../starter/index.html), [starter/app.js](../../starter/app.js); compare with [reference/index.html](../../reference/index.html), [reference/app.js](../../reference/app.js) later | [Lab A](./labs/README.md#lab-a-change-one-ui-section-safely) |
| Topic packs and local data | [Data And Context](./lessons/05-data-and-context.md) | [starter/data.js](../../starter/data.js); compare with [reference/data.js](../../reference/data.js) later | [Lab B](./labs/README.md#lab-b-add-a-new-topic-pack) |
...
| Local versus deployed AI path | [Soma App Architecture](./lessons/03-soma-architecture.md) | [scripts/mock-coach-server.js](../../scripts/mock-coach-server.js), [api/coach.js](../../api/coach.js), [vercel.json](../../vercel.json) | [Lab D](./labs/README.md#lab-d-change-model-settings-and-observe-variability) |
...
| Agent loops | [Agents](./lessons/11-agents.md) | Current app flow in [reference/app.js](../../reference/app.js); future extension idea | [Build Your Own](./lessons/13-build-your-own.md) |
| Safety and variability | [Safety And Variability](./lessons/12-safety-and-variability.md) | [reference/app.js](../../reference/app.js), [api/coach.js](../../api/coach.js), [tests/soma-student.spec.js](../../tests/soma-student.spec.js) | [Lab F](./labs/README.md#lab-f-debug-a-bad-json-response) |
