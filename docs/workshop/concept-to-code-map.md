...
| [Session 3: Data And Intelligence](./sessions/03-data-intelligence.md) | [Data And Context](./lessons/05-data-and-context.md), [LLM Prompts](./lessons/06-llm-prompts.md), [Calling The LLM](./lessons/07-calling-the-llm.md) | `starter/data.js`, `starter/app.js`; compare with `reference/data.js`, `reference/app.js`, `api/coach.js`, `lib/coach-core.js` after the scaffold pattern is clear | [Create Dummy Data](../student/ai-coding-prompts.md#create-dummy-data), [Build The /api/coach Context](../student/ai-coding-prompts.md#build-the-apicoach-context) |
